...
namespace wolf
{
	...
	public:
		...
		void BindCubemapTex(int texUnit = 0) const;
		...
		void SetCubemapFilterMode(FilterMode minFilter, FilterMode magFilter = FM_Invalid);
	...
	private:
		...
		void LoadImagesAsCubemap(const std::vector<std::string> &paths);
		//-------------------------------------------------------------------------
